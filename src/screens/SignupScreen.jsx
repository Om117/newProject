    ...
    try {
      ...
      seterror(
        ...
        >
          ...
          <span class="block sm:inline">email Already exists or</span>
          <span class="block sm:inline">password atleast 8 digit</span>
      ...
      console.log("Error:: handleSignup Error --", error);
    }
    setName("");
    setEmail("");
    setPassword("");
